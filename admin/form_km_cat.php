...
$cat_km_id = $_GET['cat_km_id'];
	...
	$sql = "select * from t_km_cat
			where cat_km_id = ".$_GET['cat_km_id'];
		        ...
		        if ($_FILES['images']['size'][$f] > $max_file_size) {
		            ...
		            if(move_uploaded_file($_FILES["images"]["tmp_name"][$f], $mpath_img.$name)) {
		            	$sql = "Update t_km_cat set
								icon = '$path_img$name'
								where cat_km_id = $cat_km_id ";
						mysql_query($sql);
		            	$count++; // Number of successfully uploaded files
		            	header("Refresh:0; url=form_km_cat.php?cat_km_id=$cat_km_id");
		            }
		        }
		    }
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
                        ...
                        <div class="panel-body">
						   ...
						   <input type="hidden" name="cat_km_id" id="cat_km_id" value="<?=$_GET['cat_km_id'] ?>">
...
function cmdCancel(){
	...
	window.location.href = "km_catergory.php";
