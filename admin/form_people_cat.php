...
$userid = $_SESSION['userid'];
	...
	$sql = "select * from t_people_cat
			where cat_people_id = ".$_GET['cat_people_id'];
...
<div class="container">
		<div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><span>บุคลากรดีเด่นด้านการเกษตร</span></h3>
				<ol class="breadcrumb">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
                        ...
                        <div class="panel-body">
						   ...
						   <input type="hidden" name="service_id" id="service_id" value="<?=$_GET['cat_people_id'] ?>">
	...
	<input type="hidden" name="Cat" id="Cat" value="<?=$_GET['cat_people_id']?>" >
...
function cmdSaveC(){
	...
	$.ajax({
		type: "POST",
		url: "function/save_people_cat.php",
		data: params,
