							...
							<div class='article_box'>";
								echo "<div  class='adminDiv text-right'> ";
									echo "
										...
										<a href='form_article_sub.php?article_id=".$row['article_id']."' class='btn btn-info btn-xs'><i class='fa fa-pencil-square-o'></i> แก้ไข</a>
										";
										if($row['active'] == 0){
											echo " <a href='#' class='btn btn-success btn-xs' onclick='cmdShow(".$row['article_id'].")'><i class='fa fa-minus-square-o'></i> แสดง</a>";
										}else{
											echo " <a href='#' class='btn btn-warning btn-xs' onclick='cmdHidden(".$row['article_id'].")'><i class='fa fa-minus-square-o'></i> ซ่อน</a>";
										}
																
											echo " <a href='#' class='btn btn-danger btn-xs' onclick='cmdDel(".$row['article_id'].")'><i class='fa fa-trash-o'></i> ลบ</a>
