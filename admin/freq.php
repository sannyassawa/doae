									...
									while ($row = mysql_fetch_array($data)) {
										...
										echo "<tr>";
											...
											echo "<td  class='text-right adminDiv' style='width:240px;'>";
												echo "
														<a href='form_freq.php?freq_id=".$row['freq_id']."' class='btn btn-info btn-xs'><i class='fa fa-pencil-square-o'></i> แก้ไข</a>
														";
														if($row['active'] == 0){
															echo " <a href='#' class='btn btn-success btn-xs' onclick='cmdShow(".$row['freq_id'].")'><i class='fa fa-minus-square-o'></i> แสดง</a>";
														}else{
															echo " <a href='#' class='btn btn-warning btn-xs' onclick='cmdHidden(".$row['freq_id'].")'><i class='fa fa-minus-square-o'></i> ซ่อน</a>";
														}
														
												echo " <a href='#' class='btn btn-danger btn-xs' onclick='cmdDel(".$row['freq_id'].")'><i class='fa fa-trash-o'></i> ลบ</a>
