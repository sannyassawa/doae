...
$sql = "SELECT * FROM t_product where active = 1 AND product_id = ".$_GET['Id'];
		...
		<div class="row">
            <div class="col-lg-12">
				...
				<div class='adminDiv text-right'>	
						<a href="form_product.php?product_id=<?=$_GET['Id'] ?>" class="btn btn btn-info adminDiv" >แก้ไข</a>
				</div>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li>
						<span class="en"><a href="product.php">สินค้าวิสาหกิจชุมชน</a></span>
						<span class="th"><a href="product.php">สินค้าวิสาหกิจชุมชน</a></span>
					</li>
					<li class="active">
						<span class="en"><?=$row['title_en'] ?></span><span class="th"><?=$row['title'] ?></span>
					</li>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<p class="downloadBox">
					...
					<? 
					$sql1 = "SELECT * FROM t_product_file where active = 1 AND product_id = ".$_GET['Id'];
					//echo $sql1;
